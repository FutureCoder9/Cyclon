...
CREATE TABLE Users (
    ...
    UpdatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  -- Added UpdatedAt timestamp
);
...
CREATE TABLE Vendors (
    ...
    VendorStatus VARCHAR2(10) CHECK (VendorStatus IN ('Active', 'Inactive')) DEFAULT 'Active',  -- Added VendorStatus
